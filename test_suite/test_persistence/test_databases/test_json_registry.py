...
class TestCacheClassRegistry:
    ...
    def test_cache_class_registry(self, monkeypatch, tmpdir, test_registry_list):
        """
...
class TestGenerateRegistryFromFilesystem:
    ...
    def test_generate_registry_from_filesystem(self, tmpdir, test_registry_list):
        ...
        for class_name in test_registry_list:
            ...
            test_class_path = Path.joinpath(
                test_class_dir, f"{class_name}{test_class_data_file_type}"
            )
...
class TestWriteRegistryToDisk:
    ...
    def test_write_registry_to_disk(self, tmpdir, test_registry_list):
        """
...
class TestRegisterClass:
    ...
    def test_register_class(self, monkeypatch, tmpdir, test_registry_list):
...
class TestClasslistExists:
    @pytest.mark.parametrize(
        "test_class_name, mock_registry, return_value",
        [
...
class TestCheckRegistryOnExit:
    ...
    def test_check_registry_on_exit(
        self,
        tmpdir,
        test_registry_list,
