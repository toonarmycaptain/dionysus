...
def test_class_name_only():
    ...
    test_class_name_only = Class(
        class_id=test_class_name_only_data_set["json_dict_rep"]["id"],
...
class TestClassNamePathSafeName:
    ...
    def test_path_safe_name_getter(self):
        assert (
            Class("The Knights of the Round-table: we don't say 'Ni!'").path_safe_name
            == "The_Knights_of_the_Round-table__we_don_t_say__Ni__"
        )
...
class TestClassId:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            Student(
                name="Student used to represent complex object"
            ),  # Ensure 'Any' typing is accurate.
        ],
    )
...
class TestContainsMethod:
    ...
    def test__contains__student_obj_not_in_empty_class(
        self, test_student_name_only, test_class_name_only
    ):
        assert test_class_name_only.students == []  # No students in class
    ...
    def test__contains__fixture_student_name_in_class(
        self, test_student_name_only, test_class_name_only
    ):
        assert test_class_name_only.students == []  # No students in class
        test_class_name_only.add_student(test_student_name_only)
    ...
    def test__contains__fixture_student_str_name_not_in_class(
        self, test_student_name_only, test_class_name_only
    ):
        assert test_class_name_only.students == []  # No students in class
    ...
    def test_non_str_or_student_obj_arg_throws_value_error(
        self, test_class_name_only, contains_arg
    ):
...
class TestAddStudent:
    ...
    def test_add_student_student_arg_is_student_obj(
        self, test_class_name_only, test_student_name_only
    ):
    ...
    def test_add_multiple_students(
        self, test_class_name_only, test_student_name_only, test_student_with_avatar
    ):
    ...
    def test_add_student_with_kwargs(
        ...
        test_class_name_only.add_student(
            name=test_student_with_avatar.name,
    ...
    def test_add_student_non_student_student_arg_raises_error(
        self, test_class_name_only, student_arg
    ):
        """
    ...
    def test_add_student_with_non_str_name_kwarg(
        self,
...
class TestFromFile:
    @pytest.mark.parametrize("class_def", [Class, NewClass])
    @pytest.mark.parametrize("test_class", ("test_class_name_only", "test_full_class"))
    def test_from_file_load_full_class(self, request, tmp_path, class_def, test_class):
        test_class = request.getfixturevalue(test_class)
    ...
    @pytest.mark.parametrize("class_def", [Class, NewClass])
    @pytest.mark.parametrize("test_class", ("test_class_name_only", "test_full_class"))
    def test_from_file_load_full_class_is_correct_type(
        self, request, tmp_path, class_def, test_class
    ):
        """Method should return instance of calling class/subclass."""
        test_class = request.getfixturevalue(test_class)
        # Setup test data file:
