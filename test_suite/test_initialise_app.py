...
class TestAppConfig:
    def test_app_config_no_settings_file(self, monkeypatch):
        ...
        assert all(
            [
                welcome_to_program_mock["called"],
...
class TestDataFolderCheck:
    @pytest.mark.parametrize(
        "default_path", [r"./dionysus_app/app_data", r"./dionysus_app/app_data/temp"]
    )
    def test_data_folder_check_default(self, monkeypatch, tmpdir, default_path):
