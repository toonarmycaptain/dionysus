...
class TestStudentId:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            Class(
                name="Class used to represent complex object"
...
class TestStudentClassId:
    ...
    def test_id(self, class_id_arg):
        assert (
            Student(name="Arthur, King of the Britons", class_id=class_id_arg).class_id
            == class_id_arg
        )
...
class TestStudentAvatar:
    ...
    def test_instantiate_with_avatar_id(self):
        test_instantiate_student_with_avatar = Student(
            self.test_name, avatar_id=self.test_avatar_id
        )
...
class TestStudentJsonDict:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                Student("Sir Lancelot: the Brave", avatar_id=None),
...
class TestStudentRepr:
    ...
    def test_repr(self, student_object):
        assert repr(student_object) == (
            f"{student_object.__class__.__module__}"
