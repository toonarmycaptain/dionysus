...
class TestTakeMainMenuInput:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                None,
                True,
            ),  # User quit, None because no function should be called.
            (
                ["Q"],
                None,
                True,
    ...
    def test_take_main_menu_input_quit(
        self,
        monkeypatch,
        valid_input,
        called_function,
        ...
        called = {
            called_function: False,  # Initialise called_function as False ie not called.
            None: True,
        }  # Initialise None=True: None won't be called (reset None=True if called_function=None).
...
class TestRunMainMenu:
    def test_run_main_menu(self, monkeypatch):
        ...
        mocked_take_main_menu_input_returns = [
            None,
            None,
            True,
        ]  # 2 mock feature calls, call to quit.
        with patch(
            "dionysus_app.UI_menus.main_menu.take_main_menu_input",
