...
class TestRunSettingsMenu:
    def test_run_settings_menu(self, monkeypatch):
        ...
        monkeypatch.setattr(
            settings_menu, "take_settings_menu_input", mocked_take_settings_menu_input
        )
...
class TestTakeSettingsMenuInput:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                None,
                True,
            ),  # Return to menu without choosing option, None as no function called.
            pytest.param(
                ["1"],
                "call_set_database_backend",
                None,
    ...
    def test_take_settings_menu_input(
        ...
        monkeypatch.setattr(
            settings_menu, "call_set_database_backend", mocked_call_set_database_backend
        )
