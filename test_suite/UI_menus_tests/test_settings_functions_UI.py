...
class TestGetUserChoiceToSetLocation:
    ...
    def test_get_user_choice_to_set_location(
...
class TestUserDecidesToSetDefaultLocation:
    ...
    def test_user_decides_to_set_default_location(self, monkeypatch, user_choice):
        monkeypatch.setattr(
            settings_functions_UI, "welcome_set_default_location_message", lambda: None
        )
        monkeypatch.setattr(
            settings_functions_UI,
            "get_user_choice_to_set_location",
            lambda: user_choice,
        )
...
class TestUserSetChartSaveFolder:
    ...
    def test_user_set_set_chart_folder_blank_input(
        ...
        mock_APP_DEFAULT_CHART_SAVE_FOLDER,
        expected_return,
    ):
        monkeypatch.setattr(
            settings_functions_UI,
            "select_folder_dialogue",
            lambda **args: user_folder_selection,
        )
        monkeypatch.setattr(
            settings_functions_UI,
