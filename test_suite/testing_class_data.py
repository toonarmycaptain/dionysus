...
test_full_class_data_set_json_dict = {
    "name": "test_class",
    "students": [
...
test_full_class_data_set_enumerated_dict = {
    1: "Cali",
    2: "Monty",
    3: "Abby",
    4: "Zach",
...
test_full_class_data_set = {
    "json_str_rep": test_full_class_data_set_json_string,
...
old_style_testing_class_data_set_loaded_dict = {
    "Cali": ["Cali_avatar.png"],
    "Monty": [None],
    "Abby": [None],
    "Zach": ["Zach_avatar.png"],
    "Janell": [None],
    "Matthew": [None],
    "Olivia": [None],
    "Regina": [None],
    "Ashley": ["Ashley_avatar.png"],
    "Alex": [None],
    "Melissa": [None],
    "Edgar": [None],
    "Danielle": ["Danielle_avatar.png"],
    "Kayla": [None],
    "Jaleigh": [None],
}

old_style_testing_class_data_set_enumerated_dict = {
    1: "Cali",
    2: "Monty",
    3: "Abby",
    4: "Zach",
