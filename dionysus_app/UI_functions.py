...
def scrub_candidate_filename(dirty_string: str):
    """
    Cleans string of non-alpha-numeric characters, but leaves spaces and underscores.

    :param dirty_string: str
    :return: str
    """
    allowed_special_characters = [' ', '_']
    "".join([c for c in dirty_string if c.isalnum() or c in allowed_special_character]).rstrip()
    return clean_string
